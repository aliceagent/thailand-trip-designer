...
const DESTINATIONS = {
  bangkok: {
    key: "bangkok",
    name: "Bangkok",
    tagline: "The dazzling, temple-studded capital — and the kosher heart of Thailand.",
    emoji: "🏙️",
    ...
    bestFor: "Culture, kosher dining, an easy first Shabbos, and world-class sightseeing.",
    highlights: [
      "The Grand Palace & Wat Phra Kaew (Emerald Buddha) — pure golden grandeur",
      "Wat Arun and Wat Pho (the giant Reclining Buddha) along the river",
  ...
  chiangmai: {
    key: "chiangmai",
    name: "Chiang Mai",
    tagline: "Cool mountain air, ancient temples, elephants and gentle northern charm.",
    emoji: "⛰️",
    image: "https://images.unsplash.com/photo-1598935888738-cd2622bcd437?auto=format&fit=crop&w=1200&q=80",
    region: "North",
    affinity: { nature: 3, culture: 3, wellness: 2, relax: 2, heat: -2, adventure: 2, crowds: -1, observance: 2, kosherStrict: 2, city: 1, beach: -3 },
    bestFor: "Nature lovers, temple-and-culture fans, and anyone who wilts in the heat.",
    highlights: [
      "Doi Suthep — the golden hilltop temple with views over the whole valley",
      "An ethical elephant sanctuary morning — feeding and bathing gentle giants",
      "The atmospheric Old City walls and dozens of serene temples",
      "The Sunday Walking Street night market for crafts and color",
      "Cooler weather, misty mountains and rice terraces",
  ...
  kohsamui: {
    ...
    highlights: [
      ...
      "The Big Buddha temple and colorful Fisherman's Village",
  ...
  krabi: {
    ...
    highlights: [
      ...
      "The famous 'Four Islands' and Hong Islands tours",
